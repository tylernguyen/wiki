...
It is robust, cross-platform, and well integrated. 1Password also offers various developer functions that cannot be matched by other offerings. These include:
...
- ![Visual Studio Code](https://assets.tylernguyen.wiki/logos/VSCode.svg){ .twemoji } [Visual Studio Code :octicons-arrow-up-right-16:](https://code.visualstudio.com/)
- :simple-zedindustries:{ .foreground } [Zed :octicons-arrow-up-right-16:](https://zed.dev/)
- :simple-cursor:{ .cursor } [Cursor :octicons-arrow-up-right-16:]()
