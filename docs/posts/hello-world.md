...
[:lucide-file-code-corner:](https://github.com/squidfunk/mkdocs-material){ .extra title="Source Code" }
[:lucide-scale:](https://github.com/squidfunk/mkdocs-material/blob/master/LICENSE){ .extra title=License }
